...
export const options = {
    scenarios: {
        test: {
            executor: 'ramping-vus', // ramping-vus executor linearly increases the number of VUs from 0 (startVUs) to the specified target.
...
export default function () {
    http.post("http://127.0.0.1:8080/stress", "1");
}
